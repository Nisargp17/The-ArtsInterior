function Studio_home2() {
  return (
    <>
      <section className="flex h-[80vh] justify-center items-center bg-[url(/src/assets/bg-slider-home3-dark.png)] bg-[black] text-[white] ">
        ...
        <div className="w-[44vw]">
          <img
            ...
            src="/src/assets/image2-home3.png"
            alt=""
          />
        </div>
