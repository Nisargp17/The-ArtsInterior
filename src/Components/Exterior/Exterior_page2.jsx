      ...
      <section className="flex flex-col py-[3vh] bg-black justify-center items-center ">
        ...
        <div className="h-1/6 flex justify-center items-center gap-[10vh] py-[3vh]">
          <div className="h-[50vh] w-[40vw]">
            <img className="h-[50vh] " src="/src/assets/Exterior1.jpg" alt="" />
          </div>
          <div className="w-[30vw] text-white h-[50vh] flex flex-col justify-center items-start">
            ...
            <div className="text-[20px] text-[#989898] py-[1vh]">
              ...
              interventions in this very unique context, a landscape dominated
        ...
        <div className="h-1/6 flex justify-center items-center gap-[10vh] py-[3vh]">
          <div className="w-[30vw] text-white h-[50vh] flex flex-col justify-center items-end">
            ...
            <div className="text-[20px] text-[#989898] py-[1vh] text-right">
              ...
              members of Parliament, 18 commission halls and catering centre and
              service areas.
            </div>
            <div className="text-[20px] font-[300] py-[1vh]">READ -{">"}</div>
          </div>
          <div className="h-[50vh] w-[40vw]">
            <img className="h-[50vh] " src="/src/assets/Exterior2.jpg" alt="" />
          </div>
        </div>
        <div className="h-1/6 flex justify-center items-center gap-[10vh] py-[3vh]">
          <div className="h-[50vh] w-[40vw]">
            <img className="h-[50vh] " src="/src/assets/Exterior3.jpg" alt="" />
          </div>
          <div className="w-[30vw] text-white h-[50vh] flex flex-col justify-center items-start">
            <div className="project_text_hover text-[2.5vw] font-[300] py-[1vh]">
              Yabroudi Villa
        ...
        <div className="h-1/6 flex justify-center items-center gap-[10vh] py-[3vh]">
          <div className="w-[30vw] text-white h-[50vh] flex flex-col justify-center items-end">
            ...
            <div className="text-[20px] text-[#989898] py-[1vh] text-right">
              ...
              from a unique landscape, between the sea and the mountains, as an
              oasis where palm trees and mineral colonnades offer cool public
              spaces.
            </div>
            <div className="text-[20px] font-[300] py-[1vh]">READ -{">"}</div>
          </div>
          <div className="h-[50vh] w-[40vw]">
            <img className="h-[50vh] " src="/src/assets/Exterior4.jpg" alt="" />
          </div>
        </div>
        <div className="h-1/6 flex justify-center items-center gap-[10vh] py-[3vh]">
          <div className="h-[50vh] w-[40vw]">
            <img className="h-[50vh] " src="/src/assets/Exterior5.jpg" alt="" />
          </div>
          <div className="w-[30vw] text-white h-[50vh] flex flex-col justify-center items-start">
            <div className="project_text_hover text-[2.5vw] font-[300] py-[1vh]">
              Dalbourne Villa
        ...
        <div className="h-1/6 flex justify-center items-center gap-[10vh] py-[3vh]">
          ...
          <div className="h-[50vh] w-[40vw]">
            <img className="h-[50vh] " src="/src/assets/Exterior6.jpg" alt="" />
          </div>
        </div>
      </section>
    </>
